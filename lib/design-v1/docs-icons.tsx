// Docs section icons, ported verbatim from docs/docs-data.js's DOC_ICONS.
import type { DocIconName } from "./docs-data";

export function DocIcon({ name, size = 20, className }: { name: DocIconName; size?: number; className?: string }) {
  const props = {
    width: size,
    height: size,
    viewBox: "0 0 24 24",
